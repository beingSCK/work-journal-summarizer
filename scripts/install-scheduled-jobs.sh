...
cp "$PLIST_DIR/com.das.heartbeat.plist" "$LAUNCH_AGENTS/"
...
launchctl load "$LAUNCH_AGENTS/com.das.heartbeat.plist"

echo ""
echo "Installation complete!"
echo ""
echo "Jobs installed:"
echo "  - com.sck.work-journal-summarizer (daily at 10:00 AM - bi-weekly summaries)"
echo "  - com.sck.work-journal-summarizer-replies (hourly - reply processing)"
echo "  - com.das.heartbeat (daily at 1:00 AM - daily heartbeat + auto-wrapup)"
echo ""
echo "Verify with: launchctl list | grep -E 'work-journal|das'"
...
echo "  launchctl start com.das.heartbeat"
echo ""
